    ...
    <View style={styles.container}>
      ...
      <View style={styles.centerbox}>
        <View style={styles.place}>
          <Text style={styles.tagb}>Tagbilaran City</Text>
          <Text style={styles.init}>Mostly cloudy 30%</Text>
        </View>
        <View style={styles.cloud}>
          <Text style={styles.num}>81°F</Text>
          <Icons2 name="cloud" size={20} color={"white"}></Icons2>
        </View>
      </View>
      <Image
        style={styles.img1}
        source={require("./stlyesheet/images/img.png")}
      />
      <View>
        <Text style={styles.dis}>
          Research Claims Lakers, Wariors Have 'Most{"\n"}Annoying Fans In NBA'
        </Text>
      </View>
      ...
      <View style={styles.mainfooter}>
        <View style={styles.footer}>
          ...
          <View style={styles.dis3}>
            <Icons1 name="bookmarks-outline" size={20} color={"white"}></Icons1>
